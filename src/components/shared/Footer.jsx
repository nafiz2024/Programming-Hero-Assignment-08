        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_.95fr_.8fr_.9fr]">
          <div>
            ...
            <p className="mt-6 max-w-xs text-base leading-8 text-slate-300">
              Empowering you with the skills to learn, grow, and achieve your
              goals through practical, career-focused education.
            </p>
          ...
          <div>
            ...
            <div className="mt-10">
              ...
              <p className="mt-3 max-w-sm text-sm leading-7 text-slate-300">
                Get the latest updates, new courses and offers directly in your
                inbox.
              </p>
