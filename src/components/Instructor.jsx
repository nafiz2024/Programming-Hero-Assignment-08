    ...
    <section className="relative overflow-hidden px-4 py-8 sm:px-6 lg:px-0">
      ...
      <div className="relative mb-10 text-center">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-slate-600 sm:text-base">
          Learn from standout mentors who bring real experience, strong
          guidance, and practical insight into every course.
        </p>
      </div>
            ...
            <div className="mt-auto flex items-center justify-between pt-6">
              <div className="flex items-center gap-1 text-amber-400">
                {Array.from({ length: 5 }).map((_, starIndex) => (
                  <FaStar
                    key={starIndex}
                    className="text-lg drop-shadow-[0_2px_6px_rgba(251,191,36,0.35)]"
                  />
                ))}
              </div>
