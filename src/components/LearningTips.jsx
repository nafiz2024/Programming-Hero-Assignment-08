  ...
  const tips = [
    {
      ...
      description:
        'Develop a consistent daily learning rhythm by isolating one core concept at a time, allowing deeper understanding and long-term retention instead of surface-level knowledge.',
    },
    {
      id: 2,
      icon: <GiBrain />,
      ...
      description:
        'Revisit and actively recall key concepts after each session to reinforce memory, strengthen understanding, and make it easier to apply knowledge in real-world scenarios.',
    },
    {
      id: 3,
      icon: <GiBullseye />,
      ...
      description:
        'Engage in purposeful, task-driven practice with real-world mini projects, while tracking progress to maintain motivation and continuously measure improvement.',
    },
  ];
    ...
    <section className="relative overflow-hidden px-4 py-8 sm:px-6 lg:px-0">
      ...
      <div className="relative mb-10 text-center">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-slate-600 sm:text-base">
          A few simple learning habits can make your progress more consistent,
