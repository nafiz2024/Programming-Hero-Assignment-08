...
const ProfilePage = () => {
    return (
        <section className="relative overflow-hidden px-4 py-12 sm:px-6 lg:px-0">
            ...
            <div className="mx-auto max-w-md">
                <div className="relative overflow-hidden rounded-[2rem] border border-emerald-100/80 bg-white/95 p-6 text-center shadow-[0_28px_80px_-40px_rgba(16,185,129,0.45)] backdrop-blur-sm sm:p-8">
                    ...
                    <div className="mt-3 inline-flex items-center gap-2 rounded-full bg-slate-50 px-4 py-2 text-sm font-medium text-slate-600">
                        <FiMail className="text-emerald-600" />
                        email@skillsphere.com
                    </div>
