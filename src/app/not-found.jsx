                ...
                <div className="grid gap-10 p-6 sm:p-8 lg:grid-cols-[1.08fr_.92fr] lg:p-12">
                    <div className="relative z-10">
                        ...
                        <p className="mt-5 max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">
                            The destination you requested is unavailable right now. Let&apos;s guide you back to the most useful parts of SkillSphere without losing momentum.
                        </p>
                            ...
                            <div className="relative mt-8 space-y-4">
                                <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                                    ...
                                    <p className="mt-2 text-sm leading-7 text-slate-300">
                                        Jump back to the homepage or explore the course library to continue your learning flow.
                                    </p>
                                </div>
                                ...
                                <div className="grid gap-3">
                                    ...
                                    >
                                        <div className="flex items-center justify-between gap-3">
                                            <div>
                                                <p className="text-sm font-semibold text-white">About SkillSphere</p>
