          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="rounded-[1.75rem] border border-emerald-100/80 bg-white p-5 shadow-sm shadow-emerald-100">
              <div className="flex items-center gap-4">
                <img
                  src={
                    ...
                    `https://ui-avatars.com/api/?name=${encodeURIComponent(courseDetails.instructor)}&background=ecfdf5&color=047857&bold=true`
                  }
              ...
              <p className="mt-4 text-sm leading-7 text-slate-600">
                {matchedInstructor?.description ||
                  'An experienced mentor focused on practical learning, clear explanations, and career-ready skill development.'}
              </p>
              ...
              <div className="mt-5 flex flex-wrap items-center gap-3">
                <span className="inline-flex items-center gap-2 rounded-full border border-amber-200 bg-white px-3 py-1 text-sm font-bold text-amber-700 shadow-sm shadow-amber-100">
                  ...
                  {matchedInstructor?.rating || courseDetails.rating}/5
                  Instructor Rating
                </span>
      ...
      <div className="relative mt-8 grid gap-8 lg:grid-cols-[1.08fr_.92fr]">
        <div className="rounded-[2rem] border border-emerald-100/80 bg-white/90 p-6 shadow-[0_20px_60px_-34px_rgba(16,185,129,0.4)] sm:p-8">
          ...
          <p className="mt-5 text-sm leading-8 text-slate-600 sm:text-base">
            This course is designed to move you from foundational understanding
            to confident execution. You&apos;ll learn key concepts, apply them
            through practical modules, and finish with a clearer roadmap for
            using these skills in real projects.
          </p>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <div className="rounded-[1.5rem] border border-slate-100 bg-slate-50/80 p-5">
              ...
              <p className="mt-2 text-sm leading-7 text-slate-600">
                Each module emphasizes real-world application instead of passive
                theory.
              </p>
            </div>
            ...
            <div className="rounded-[1.5rem] border border-slate-100 bg-slate-50/80 p-5">
              ...
              <p className="mt-2 text-sm leading-7 text-slate-600">
                Lessons are arranged to help you build confidence step by step
                without overwhelm.
              </p>
            </div>
          </div>
