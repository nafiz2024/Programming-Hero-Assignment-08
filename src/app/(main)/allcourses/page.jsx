...
const AllCourses = async () => {
  ...
  const popularCourses = courses.filter(
    (course) => course.popularCourse === true,
  ).length;
        ...
        <div className="relative grid gap-8 lg:grid-cols-[1.05fr_.95fr]">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">
              Browse our complete learning catalog across development, design,
              marketing, and data. Each course is crafted to help you move from
      ...
      <div className="relative mt-8">
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-slate-600 sm:text-base">
            Choose the path that fits your pace, goals, and curiosity. Every
            course is structured to feel practical, guided, and worth your time.
          </p>
        </div>
